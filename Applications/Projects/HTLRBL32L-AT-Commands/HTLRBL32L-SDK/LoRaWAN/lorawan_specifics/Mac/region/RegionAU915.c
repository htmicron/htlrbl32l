    ...
    for( uint8_t i = 0, k = 0; i < AU915_MAX_NB_CHANNELS; i += 16, k++ )
    {
        for( uint8_t j = 0; j < 16; j++ )
        {
            if( ( channelsMask[k] & ( 1 << j ) ) != 0 )
            {
             ...
             //   printf("Channel: %d freq: %lu | ", i + j,channels[i+j].Frequency);
//			printf("%lu\n",channels[i+j].Frequency);
...
//		frequency = 916800000;
//		printf("LoRaWAN frequency hardcoded: %d\n",frequency);
    Radio.SetChannel( frequency );

    // Radio configuration
//    Radio.SetRxConfig( MODEM_LORA, rxConfig->Bandwidth, phyDr, 1, 0, 8, 0, false, 0, false, 0, 0, true, rxConfig->RxContinuous );
//    Radio.SetRxConfig( MODEM_LORA, rxConfig->Bandwidth, phyDr, 1, 0, 8, 0, false, 0, false, 0, 0, true, rxConfig->RxContinuous );
    Radio.SetRxConfig( MODEM_LORA, rxConfig->Bandwidth, phyDr, 1, 0, 8, 0, false, 0, true, 0, 0, true, rxConfig->RxContinuous );
...
bool RegionAU915TxConfig( TxConfigParams_t* txConfig, int8_t* txPower, TimerTime_t* txTimeOnAir )
{
    ...
    // Setup the radio frequency
	  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//		NvmCtx.Channels[txConfig->Channel].Frequency = 916800000;
//		printf("Frequency Hardcoded = %u\n",NvmCtx.Channels[txConfig->Channel].Frequency);	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
