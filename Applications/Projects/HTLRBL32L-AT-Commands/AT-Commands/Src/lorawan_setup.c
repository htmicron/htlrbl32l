...
void LORAWAN_init(void){
	...
	SX126xReset();
	//sets LoRaWAN region	
	LoRaParamInit.AdrEnable=at_control.adr;
	LoRaParamInit.EnablePublicNetwork=at_control.nwk_mode;
	LoRaParamInit.TxDatarate=at_control.default_dr;
...
static void LORA_RxData( lora_AppData_t *AppData ){
  switch (AppData->Port)
  {
    ...
    case LORAWAN_APP_PORT:
		...
		at_control.rx_data.last_payload=AppData->Buff;
		at_control.rx_data.size=AppData->BuffSize;
		at_control.rx_data.new_data_flag=1;
...
//		
////		appData.Buff = (uint8_t*)"teste12345678657657457645";
//		appData.BuffSize = strlen((const char*)appData.Buff);
