...
//            NvmCtx.ChannelsDefaultMask[5] = 0x0000;
			...
			for(int x=0;x<6;x++){
				NvmCtx.ChannelsDefaultMask[x] = at_control.channel_mask[x];
			}
...
//			printf("chmask %04x,ctrl:%u, DR: %u, nbrep: %u txpower:%u \n",linkAdrParams.ChMask,linkAdrParams.ChMaskCtrl ,linkAdrParams.Datarate,linkAdrParams.NbRep,linkAdrParams.TxPower);
		}
