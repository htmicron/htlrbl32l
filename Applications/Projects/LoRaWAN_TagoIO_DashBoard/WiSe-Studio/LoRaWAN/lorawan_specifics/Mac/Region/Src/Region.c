...
#define IN865_CASE                                 case LORAMAC_REGION_IN865:
#define IN865_IS_ACTIVE( )                         IN865_CASE {printf("t1"); }
#define IN865_GET_PHY_PARAM( )                     IN865_CASE {printf("t2"); }
#define IN865_SET_BAND_TX_DONE( )                 IN865_CASE {printf("t3"); }
#define IN865_INIT_DEFAULTS( )                     IN865_CASE {printf("t4"); }
#define IN865_GET_NVM_CTX( )                      IN865_CASE {printf("t5"); }
#define IN865_VERIFY( )                            IN865_CASE {printf("t6"); }
#define IN865_APPLY_CF_LIST( )                     IN865_CASE {printf("t7"); }
#define IN865_CHAN_MASK_SET( )                     IN865_CASE {printf("t8"); }
#define IN865_COMPUTE_RX_WINDOW_PARAMETERS( )      IN865_CASE {printf("t9"); }
#define IN865_RX_CONFIG( )                        IN865_CASE {printf("t10"); }
#define IN865_TX_CONFIG( )                         IN865_CASE {printf("t11"); }
#define IN865_LINK_ADR_REQ( )                     IN865_CASE {printf("t12"); }
#define IN865_RX_PARAM_SETUP_REQ( )              IN865_CASE {printf("t13"); }
#define IN865_NEW_CHANNEL_REQ( )                  IN865_CASE {printf("t14"); }
#define IN865_TX_PARAM_SETUP_REQ( )               IN865_CASE {printf("t15"); }
#define IN865_DL_CHANNEL_REQ( )                    IN865_CASE {printf("t16"); }
#define IN865_ALTERNATE_DR( )                      IN865_CASE {printf("t17"); }
#define IN865_CALC_BACKOFF( )                      IN865_CASE {printf("t18"); }
#define IN865_NEXT_CHANNEL( )                     IN865_CASE {printf("t19"); }
#define IN865_CHANNEL_ADD( )                       IN865_CASE {printf("t20"); }
#define IN865_CHANNEL_REMOVE( )                    IN865_CASE {printf("t21"); }
#define IN865_SET_CONTINUOUS_WAVE( )               IN865_CASE {printf("t22"); }
#define IN865_APPLY_DR_OFFSET( )                   IN865_CASE {printf("t23"); }
#define IN865_RX_BEACON_SETUP( )                IN865_CASE {printf("t24"); }
...
{
//		printf("Region RX Configs  | Datarate: %u | Bandwidth: %u | DrOffset: %u \n",rxConfig->Channel,rxConfig->Datarate, rxConfig->Bandwidth, rxConfig->DrOffset);
    switch( region )
    {
        AS923_RX_CONFIG( );
        AU915_RX_CONFIG( );
