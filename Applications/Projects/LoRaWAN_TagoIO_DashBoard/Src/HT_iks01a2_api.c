...
static void HT_IKS01A2_HTS221_Init(void){
	...
	HAL_I2C_Mem_Write(&hi2c, HTS221_WRITE_ADDR, 0x20, I2C_MEMADD_SIZE_8BIT, &reg, 1, I2C_APP_TIMEOUT);
...
static void HT_IKS01A2_LSP22HB_Init(void){
	...
	HAL_I2C_Mem_Write(&hi2c, 0xBA, 0x10, I2C_MEMADD_SIZE_8BIT,&buffer[0],1,I2C_APP_TIMEOUT); //REG1
	HAL_I2C_Mem_Write(&hi2c, 0xBA, 0x11, I2C_MEMADD_SIZE_8BIT,&buffer[1],1,I2C_APP_TIMEOUT); //REG2
...
static void HT_IKS01A2_CalibrateTemperatureHTS221(void){
	...
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x32, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1,I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x33, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1,I2C_APP_TIMEOUT);
	T0_degC_x8_u8 = buffer[0] & 0xFF;
	T1_degC_x8_u8 = buffer[1] & 0xFF;
	
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x35, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1,I2C_APP_TIMEOUT);
	x = buffer[0] &0x0F;
	T0_degC = ((x & 0x03) * 256) + T0_degC_x8_u8;
	T1_degC = ((x & 0x0C) * 64) + T1_degC_x8_u8;
	
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3C, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1,I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3D, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1,I2C_APP_TIMEOUT);
	T0_OUT = ((buffer[1] & 0xFF) * 256) + (buffer[0] & 0xFF);

	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3E, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1,I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3F, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1,I2C_APP_TIMEOUT);
...
static void HT_IKS01A2_CalibrateHumidityHTS221(void){
	...
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x30, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1 , I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x31, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1 , I2C_APP_TIMEOUT);
	H0_rH_x2 = buffer[0];
	H1_rH_x2 = buffer[1];
	...
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x36, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1 , I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x37, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1 , I2C_APP_TIMEOUT);
	
	H0_T0_OUT = ((buffer[1] & 0xFF) * 256) + (buffer[0] & 0xFF); 
	
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3A, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1 , I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x3B, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1 , I2C_APP_TIMEOUT);
...
static float HT_IKS01A2_ReadTemperatureHTS221(void){
	...
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x2A, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1, I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x2B, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1, I2C_APP_TIMEOUT);
...
static float HT_IKS01A2_ReadHumidity(void) {	
	...
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x28, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1 , I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, HTS221_READ_ADDR, 0x29, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1 , I2C_APP_TIMEOUT);
...
static float HT_IKS01A2_ReadPressure(void){
	...
	HAL_I2C_Mem_Read(&hi2c, 0xBB, 0x28, I2C_MEMADD_SIZE_8BIT, &buffer[0], 1,I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, 0xBB, 0x29, I2C_MEMADD_SIZE_8BIT, &buffer[1], 1,I2C_APP_TIMEOUT);
	HAL_I2C_Mem_Read(&hi2c, 0xBB, 0x2A, I2C_MEMADD_SIZE_8BIT, &buffer[2], 1,I2C_APP_TIMEOUT);
